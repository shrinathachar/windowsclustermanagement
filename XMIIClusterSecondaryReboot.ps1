...
$Ans = Read-Host 'Be Carefull.By running this script, You are rebooting all the xMII Secondary Cluster Nodes. Do you really want to proceed ?  Answer Yes or NO '
...
$Servers = get-content D:\shrinath\XMIIserversSecondary.txt
